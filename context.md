...
6. The result page shows the bilingual role, role statement, four fixed character-specific meme stats, team strengths, overload warning, complementary teammate, animated Pet, ZIP download, stable URL, and QR code.
